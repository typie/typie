...
export default class AbstractHastePackage {
    ...
    public setPackageName(pkgName: string): AbstractHastePackage {
        this.packageName = pkgName;
        return this;
    }

    public setDB(dbName: string): AbstractHastePackage {
        this.haste.setDB(dbName);
        return this;
    }

    public setIcon(iconPath: string): AbstractHastePackage {
        this.icon = getPath(iconPath);
        return this;
    }
