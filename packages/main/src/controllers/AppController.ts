...
import {AppGlobal, GoDispatcher, Packet} from "/@/services/sdk/index";
...
export default class AppController {
    ...
    public static bootstrapGoDispatcher(win: MainWindowController, config: ConfigLoader): Promise<void> {
